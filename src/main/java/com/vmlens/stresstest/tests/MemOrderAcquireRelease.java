...
@State
public class MemOrderAcquireRelease {
    ...
    static {
        try {
            RESULT = MethodHandles.lookup().findVarHandle(MemOrderAcquireRelease.class, "result", Object.class);
            LISTENER = MethodHandles.lookup().findVarHandle(MemOrderAcquireRelease.class, "listener", Consumer.class);
